...
export async function GET(
  ...
  return NextResponse.json({
    approval: {
      ...
      files,
      formFields: {
        material: detail.formFields?.material ?? "",
        itemSize: detail.formFields?.itemSize ?? "",
        logo1: detail.formFields?.logo1 ?? "",
        logo1Color: detail.formFields?.logo1Color ?? "",
        logo1Location: detail.formFields?.logo1Location ?? "",
        logo1Application: detail.formFields?.logo1Application ?? "",
        baseColor: detail.formFields?.baseColor ?? "",
        additionalNotes: detail.formFields?.additionalNotes ?? "",
        includeLogo2: detail.formFields?.includeLogo2 ?? false,
        logo2: detail.formFields?.logo2 ?? "",
        logo2Color: detail.formFields?.logo2Color ?? "",
        logo2Location: detail.formFields?.logo2Location ?? "",
        logo2Application: detail.formFields?.logo2Application ?? "",
